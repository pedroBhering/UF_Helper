...
@section('content')
    ...
    <a href="{{ route('materiais.create', $disciplina->id) }}" class="btn btn-dark mr-2 btn-add"><i class="fas fa-plus"></i>
        ...
        @foreach ($materiais as $material)
            <div class="mt-2">
                ...
                <div class="flex nowrap">
                    <!-- Seus botões aqui -->
                    <a href="{{ route('materiais.show', $material->id) }}" class="btn btn-dark mr-2"><i class="fas fa-eye"></i>
