                    ...
                    <div class="flex flex-column">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="mb-2" type="text" name="descricao" id="descricao" value=""
                                        required style="border-radius: 10px;">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="mb-2" type="text" name="tipo" id="tipo" value=""
                                        required style="border-radius: 10px;">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="mb-2" type="text" name="link" id="link" value=""
                                        required style="border-radius: 10px;">
                                </td>
                            </tr>
